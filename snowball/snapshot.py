    ...
    with state.lock:
            ...
            pairs.append(
                {
                    ...
                    "rsi_15m": getattr(snap, "rsi_15m", None) if snap else None,
                    "rsi_5m": getattr(snap, "rsi_5m", None) if snap else None,
                    "rsi_1d": getattr(snap, "rsi_1d", None) if snap else None,
                    "bb_upper_15m": getattr(snap, "bb_upper_15m", None) if snap else None,
                    "bb_mid_15m": getattr(snap, "bb_mid_15m", None) if snap else None,
                    "bb_lower_15m": getattr(snap, "bb_lower_15m", None) if snap else None,
                    "bb_upper_5m": getattr(snap, "bb_upper_5m", None) if snap else None,
                    "bb_mid_5m": getattr(snap, "bb_mid_5m", None) if snap else None,
                    "bb_lower_5m": getattr(snap, "bb_lower_5m", None) if snap else None,
                    ...
                    "signal_rsi_15m": getattr(snap, "signal_rsi_15m", "hold") if snap else "hold",
                    "signal_rsi_1d": getattr(snap, "signal_rsi_1d", "hold") if snap else "hold",
                    "signal_bb_15m": getattr(snap, "signal_bb_15m", "hold") if snap else "hold",
                    "signal_bb_1d": getattr(snap, "signal_bb_1d", "hold") if snap else "hold",
        ...
        return {
            ...
            "status": {
                ...
                "indicator_filters_enabled": bool(
